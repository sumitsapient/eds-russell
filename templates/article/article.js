...
// injectArticleSchema is centralised in structured-data.js (Phase 17).
// It is imported here so article.js stays focused on template UI concerns.
import { injectArticleSchema } from '../../scripts/structured-data.js';
